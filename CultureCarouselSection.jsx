...
const culturePrinciples = [
    ...
    },
    {
        ...
        description:
            " Seek to understand the purpose of every system we create. We believe relationships are built through consistency and care. Every interaction should make people want to work with us again.",
        icon: Handshake,
        gradientFrom: '#8b5cf6',
        gradientVia: '#9333ea',
        gradientTo: '#c026d3',
...
export default function CultureCarouselSection() {
    return (
        <div id='our-culture' className="relative min-h-screen flex flex-col items-center font-[Poppins] py-28 bg-transparent">
            ...
            {/* Grid Layout */}
            <div className="relative w-full max-w-xl px-6 md:px-12">
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-20">
                    {culturePrinciples.map((principle, index) => (
                        ...
                        >
                            <div className="relative rounded-2xl p-2 shadow-glow-soft" style={{ background: '#35165466' }}>
                                ...
                                {/* Main Card Content */}
                                <div className="relative rounded-xl p-8 h-full min-h-[420px] border border-white/10 group-hover:bg-gray-900/90 transition-all duration-500 flex flex-col justify-between" style={{ backgroundColor: 'rgba(17,24,39,0.95)' }}>
                                    ...
                                    <div className="flex-grow">
                                        <h3 className="text-2xl font-bold mb-4" style={{ backgroundImage: `linear-gradient(to right, ${principle.gradientFrom}, ${principle.gradientVia}, ${principle.gradientTo})`, backgroundClip: 'text', color: 'transparent' }}>
                                            {principle.title}
                                        </h3>
                                    ...
                                    <motion.div
                                        className="h-1 rounded-full opacity-60 group-hover:opacity-100 mt-6"
