  ...
  useEffect(() => {
    const handleScroll = () => {
      const sections = [
        ...
        { id: "about", name: "About The Founder" },
                ...
                <form ref={formRef} onSubmit={sendEmail} className="space-y-6">
                  ...
                  <div>
                    ...
                    >
                      ...
                      <option value="Security-&-Vulnerability">Quality Assurance</option>
                      <option value="Regression-Testing">Evals</option>
                      <option value="Test-Analytics-&-Reporting">Data Annotation</option>
